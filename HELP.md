...
- **Primary Maintainer**: Eric Sanacore ([@esanacore](https://github.com/esanacore))
- **Getting Started**: Read `README.md` and `docs/SETUP.md`.
- **Asking for Help**: see `SUPPORT.md` — GitHub Discussions for questions/ideas,
  GitHub Issues (with the matching template) for bugs/hardware-validation/docs.
